...
// Обробка даних
// Виконайте вашу логіку обробки даних тут. Наприклад, можна просто передати дані далі.
// Це можна зробити незалежно від значень полів у JSON.
// Для прикладу, просто збережемо об'єкт як є:
